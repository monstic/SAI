...
//Offload switch task's states
    ...
    LAB_REFILL_ENERGY_THRESHOLD: 1500,
    LAB_REFILL_MINERAL_THRESHOLD: 1500,
    TERMINAL_ENERGY_REFILL_THRESHOLD: 1500,
    TERMINAL_RESERVE: 20000,
    TERMINAL_FULL_THRESHOLD: TERMINAL_CAPACITY*0.95, //15000
    TERMINAL_RESTOCK_THRESHOLD: TERMINAL_CAPACITY*0.95 - 10000, //5000
    STORAGE_FULL_THRESHOLD: STORAGE_CAPACITY*0.95, //50000
    STORAGE_RESTOCK_THRESHOLD: STORAGE_CAPACITY*0.95 - 10000, //40000
    TOWER_REFILL_THRESHOLD: 0.8,
    EMERGENCY_DOWNGRADING_THRESHOLD: 1500,
    OLD_CREEP_LIFETOLIVE: 200,
    LINKER_AGE_THRESHOLD: 10,
    PORTER_PRIORITY_THRESHOLD: 750,
    TERMINAL_TERMINAL_SEND_AMOUNT: 2000,
    ...
    // Room min levels for build types
    ...
    FLAG_WALL_COLOUR: COLOR_BROWN,
    FLAG_IGNORE_COLOR: COLOR_RED,
